export function formatNumber(nb) {//Renvoie l'heure d'une date au bon format
    if (nb < 10) {
        return "0" + nb;
    }
    return nb;
...
export function getHourAndMinuteFromDate(date) {//Renvoie l'heure d'une date au bon format
